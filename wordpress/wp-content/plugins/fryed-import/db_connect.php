...
class DBconnect {
	...
	public function connect() {
		...
		//connect to DB host
		$this->connection = mysql_connect($this->host,$this->username,$this->password) or $_SESSION["errors"][] = "Error: Could not connect to database. " . mysql_error();
